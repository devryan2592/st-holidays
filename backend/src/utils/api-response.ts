...
import { HttpStatusType, ApiResponse } from "@/types/api-response.types";
...
export const sendSuccess = <T>(
  ...
  message: string,
  data?: T,
  statusCode: HttpStatusType = HTTP_STATUS.OK
): Response<ApiResponse<T>> => {
...
export const sendError = (
  res: Response,
  message: string,
  statusCode: HttpStatusType = HTTP_STATUS.BAD_REQUEST,
  errors?: string[]
